...
<Blocks title={"viewport"}>{`<svg width="500" height="500">
</svg>`}</Blocks>
...
<Blocks title={"viewbox"}>{`<svg width="500" height="500" viewbox="0 0 500 500">
</svg>`}</Blocks>
...
Example: here’s a 400 x 400 rectangle in an svg with a viewbox size of 500 x 500

<Blocks title={"viewbox 500x500"}>{`<svg
   width="500"
   height="500"
   viewbox="0 0 500 500">
...
<Blocks title={"viewbox 1000x1000"}>{`<svg
   width="500"
   height="500"
...
<Blocks title={"different aspect ratio - viewbox/viewport"}>{`<svg
   width="500"
   height="500"
...
<Blocks title={"min-x = 0 min-y = 0"}>{`<svg
   width="500"
   height="500"
   viewbox="0 0 500 500">
</svg>`}</Blocks>
...
<Blocks title={"rectangle at 0 x 0"}>{`<svg
   width="500"
   height="500"
   viewbox="0 0 500 500">
...
<Blocks title={"rectangle still at 0 x 0"}>{`<svg
   width="500"
   height="500"
