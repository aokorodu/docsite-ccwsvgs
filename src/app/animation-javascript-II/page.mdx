...
<Blocks highlight="3,4,5,6,11,12,13,14,16,17,18,19,20,21,22, 24,25,26,27,28,29,30">{`<script>
    const circ = document.querySelector("#my-circle");
    let xpos = 100; 
    let ypos = 150;
    let x_speed = 1; 
...
Now we'll dynamically create a circle element and add it to the container using the techniques we learned in the **Changing SVGs Dynamically** section

<Blocks highlight="12-19">{`<script>
class Particle {
    constructor(x, y, r, w, h) {
        this.x = x; this.y = y; this.r = r;
        this.right = w - r;
