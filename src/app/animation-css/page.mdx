...
ALL of the easing options are actually defined by cubic-bezier functions, in which two “control points” are used to change the shape of the animation curve. The graphs help to visualize how the shape of the curve affects the pace of the animation. Here’s a linear animation curve.
