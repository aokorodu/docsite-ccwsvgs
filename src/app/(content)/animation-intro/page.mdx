...
**CSS** (via transitions and keyframes) and **Javascript** (via requestAnimationFrame). Both are natively available, meaning that now external libraries will be needed.
