...
There are other attributes that we can add to our svg element, like **viewbox** and **namespace**, but this is all we need for now. We'll learn about some advanced svg attributes in our <a href={"/syntax"} target="\_blank">{"syntax"}</a> chapter.
