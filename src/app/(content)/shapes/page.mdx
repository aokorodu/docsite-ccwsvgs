...
In this section we'll discuss the basic shape elements and their attributes. A more detailed discussion of the **presentation attributes** that define look of the shape elements can be found <Link href={"/presentation-attributes"}>{"here"} </Link>.
