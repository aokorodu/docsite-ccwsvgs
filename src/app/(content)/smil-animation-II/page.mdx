...
Check out the full example on [codepen.](https://codepen.io/aokorodu/pen/OJeKNVd)

### animate attributes

1. **id** - needed to chain animations, i.e begin=”first.end”
1. **href** - (needed if animate element is not encapsulated by the element you wish to animate)
1. **attributeName**=\<name of attribute\>
1. **from** - \<value\>
1. **to** - \<value\>
1. **begin** - \<value\>
...
10. **calcMode** - \<value\> - used to set pacing, animation curves, type of motion
