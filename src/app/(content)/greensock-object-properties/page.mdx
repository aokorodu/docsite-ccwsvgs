...
The final codepen below is a much more complex example, where I'm tweening the numeric properties of a number of objects - each representing path variables for a different facial feature - in order to create a series of expressions. Feel free to play around with the variable to see what you can come up with!
